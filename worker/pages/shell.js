...
:root{
  ...
  --shadow:0 16px 38px rgba(2,71,254,.12);
}
...
.voyage-card:hover{transform:translateY(-6px);border-color:var(--line-strong)!important;box-shadow:0 20px 44px rgba(2,71,254,.16)}
...
.action-btn,.action-btn-sm{display:inline-flex;align-items:center;justify-content:center;gap:.7rem;border-radius:999px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;transition:transform .2s ease,box-shadow .2s ease,background-color .2s ease,border-color .2s ease;background:var(--blue)!important;color:#fff!important;border:1px solid rgba(2,71,254,.65);box-shadow:0 12px 28px rgba(2,71,254,.22)}
.action-btn{padding:1rem 1.55rem}
.action-btn-sm{padding:.82rem 1.18rem;font-size:.82rem}
.action-btn:hover,.action-btn-sm:hover{transform:translateY(-2px);background:var(--blue)!important;border-color:var(--blue);box-shadow:0 16px 34px rgba(2,71,254,.26)}
...
.subtle-btn:hover{transform:translateY(-2px);border-color:var(--blue);background:rgba(2,71,254,.08);color:var(--blue)}
...
#navbar{background:rgba(255,255,255,.95)!important;border-bottom:1px solid var(--line)!important;box-shadow:0 8px 24px rgba(2,71,254,.1);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}
